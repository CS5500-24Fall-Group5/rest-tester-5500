...
const MainControl: React.FC = () => {
    ...
    try {
      ...
      switch (method) {
        ...
        case "DELETE_ALL":
          if (
            checkWithUser &&
            !window.confirm("Are you sure you want to delete all users?")
          ) {
            return;
          }
        ...
        case "PUT":
          ...
          break;
        case "PATCH":
          response = await axios.patch(`${baseUrl}/users/${id}`, {
            hoursToAdd: Number(hours),
          });
          break;
        case "DELETE":
          if (
  ...
  const runTest = async (
    ...
    if (expected !== "" && !resultTmp.includes(expected)) {
      alert(
        `Failed test ${testName}: Expected ${expected} but got ${resultTmp}`
      );
    }
    if (notExpected !== "" && resultTmp.includes(notExpected)) {
      alert(
        `Failed test ${testName}: Not expecting ${notExpected} but got ${resultTmp}`
      );
    }
  ...
  return (
    <Box sx={{ width: "100%", padding: 2 }}>
      <Stack direction="row" spacing={3}>
          ...
          <Stack spacing={2}>
            <Stack direction="row" spacing={2} alignItems="center">
              <Button
                variant="contained"
                color="primary"
                onClick={() => handleCrudOperation("GET_ALL")}
              >
                GET ALL USERS
              </Button>
            </Stack>
            <Stack direction="row" spacing={2} alignItems="center">
              <Button
                ...
                color="primary"
                onClick={() =>
                  handleCrudOperation("DELETE_ALL", 0, "", 0, true)
                }
              >
                DELETE ALL USERS
              </Button>
            ...
            <Stack direction="row" spacing={2} alignItems="center">
              <Button
                variant="contained"
                color="primary"
                onClick={() => handleCrudOperation("GET")}
              >
                GET USER
              </Button>
              <TextField
            ...
            <Stack direction="row" spacing={2} alignItems="center">
              <Button
                variant="contained"
                color="primary"
                onClick={() => handleCrudOperation("POST")}
              >
                ADD USER
              </Button>
              <TextField
            ...
            <Stack direction="row" spacing={2} alignItems="center">
              <Button
                variant="contained"
                color="primary"
                onClick={() => handleCrudOperation("PUT")}
              >
                UPDATE USER
              </Button>
              <TextField
            ...
            <Stack direction="row" spacing={2} alignItems="center">
              <Button
                variant="contained"
                color="primary"
                onClick={() => handleCrudOperation("PATCH")}
              >
                ADD HOURS
              </Button>
              <TextField
            ...
            <Stack direction="row" spacing={2} alignItems="center">
              <Button
                variant="contained"
                color="secondary"
                onClick={() => handleCrudOperation("DELETE", 0, "", 0, true)}
              >
                DELETE USER
              </Button>
              <TextField
        ...
        <Paper
          elevation={3}
          sx={{ padding: 2, flex: 1, maxHeight: 600, overflow: "auto" }}
        >
